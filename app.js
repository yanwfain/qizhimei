...
App({
          ...
          n.error ? e.alert("获取用户登录态失败:" + n.message) : n.isclose && i && "function" == typeof i ? i(n.closetext, !0) : wx.getUserInfo({
            success: function (i) {
              a = i.userInfo, e.get("wxapp/auth", {
                ...
                console.log(e)
                o.setCache("olevel",e.level)
                // var that = this
                o.globalData.isread = e.is_read,
                  i.userInfo.isread = e.is_read,
                // wx.setStorageSync('isread', e.is_read)
  ...
  globalData: {
    appid: "wx836a0b34f5e78ca4",
    api: "https://www.qzmyzj.com/app/ewei_shopv2_api.php?i=3",
    approot: "https://www.qzmyzj.com/addons/ewei_shopv2/",
    userInfo: null,
    isread:'',
